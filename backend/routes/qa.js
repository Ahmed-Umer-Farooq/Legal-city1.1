...
const { authenticateToken, requireLawyer } = require('../utils/middleware');
const {
  submitQuestion,
  getQuestions,
  getQuestionById,
...
router.get('/lawyer/questions', authenticateToken, requireLawyer, getLawyerQuestions);
...
router.post('/questions/:questionId/answers', authenticateToken, requireLawyer, submitAnswer);
