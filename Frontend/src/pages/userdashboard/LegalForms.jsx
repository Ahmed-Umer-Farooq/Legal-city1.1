...
export default function LegalForms() {
  ...
  return (
    <>
      ...
      {!loading && filteredForms.length === 0 && (
        <div className="text-center py-12 bg-white rounded-lg border-2 border-dashed border-gray-300 mx-6">
          <h3 className="text-lg font-medium text-gray-900 mb-2">No forms available</h3>
          <p className="text-gray-600">Check back later for new legal forms</p>
        </div>
      )}
